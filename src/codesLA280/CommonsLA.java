...
public class CommonsLA extends JPanel {
    ...
    public CommonsLA(BranchGroup sceneBG) {
    ...
    public static void main(String[] args) {
        frame = new JFrame("LA's Common File");            // NOTE: change XY to student's initials
        frame.getContentPane().add(new CommonsLA(create_Scene()));  // create an instance of the class
