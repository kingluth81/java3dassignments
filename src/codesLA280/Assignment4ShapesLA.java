...
class RingBase extends Assignment4ShapesLA {
    ...
    protected Node create_Object() {
        return new 	Cylinder(0.5f, 0.2f, 3, 30, 30, CommonsLA.obj_Appearance(CommonsLA.Red)); //Returning desired cylinder and setting color
    }
